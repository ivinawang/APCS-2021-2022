...
BEST CASE SCENARIO/WORST CASE SCENARIO:
  There is no best or worse case- The run time will be O(n^2) because the run time of
the partition is O(n) e for loop is also O(n).

DISCO:
  When we run the code, sometimes the array ends up fully sorted by partition. Other
